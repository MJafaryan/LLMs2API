...
async function selectModel(page, modelId) {
    try {
        ...
        const modelSelector = await page.$(
            'button:has-text("Sonnet"), button:has-text("Haiku"), [class*="model-selector"], [class*="model-picker"]',
        );
        if (modelSelector) {
            ...
            if (!window.__claudeIntercepted) {
                ...
                window.fetch = async function (...args) {
                    ...
                    if (activeReqId && window.__claudeRequests[activeReqId]) {
                        window.__claudeRequests[activeReqId].debug.push(
        ...
        if (!fullResponse?.trim()) {
            ...
            fullResponse = await page.evaluate(() => {
                ...
                const messages = document.querySelectorAll(
                    '[data-message-author-role="assistant"], [class*="assistant"], [class*="response"]',
                );
